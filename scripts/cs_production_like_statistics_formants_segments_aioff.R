...
contrasts(data_ai_off_summ$context_start_lg) = c(-0.5, 0.5)
data_ai_off_summ$context_start_lgContrast = contrasts(data_ai_off_summ$context_start_lg)[,1][as.numeric(data_ai_off_summ$context_start_lg)]

# Task category (baseline set to c)
contrasts(data_ai_off_summ$task) = c(-0.5, 0.5)
data_ai_off_summ$taskContrast = contrasts(data_ai_off_summ$task)[,1][as.numeric(data_ai_off_summ$task)]
