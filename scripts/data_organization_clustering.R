...
f1_values = data_noout %>%
	select(speaker, sex, task, time_stamp, context_cat, context_start_lg, context_specific, duration_ms, percentage, f1) %>%
	spread(percentage, f1) %>%
...
f2_values = data_noout %>%
	select(speaker, sex, task, time_stamp, context_cat, context_start_lg, context_specific, duration_ms, percentage, f2) %>%
	spread(percentage, f2) %>%
...
f3_values = data_noout %>%
	select(speaker, sex, task, time_stamp, context_cat, context_start_lg, context_specific, duration_ms, percentage, f3) %>%
	spread(percentage, f3) %>%
	select(speaker, sex, task, time_stamp, context_cat, context_start_lg, context_specific, duration_ms, f3_0=`0`, f3_5=`5`, f3_10=`10`, f3_15=`15`, f3_20=`20`, f3_25=`25`, f3_30=`30`, f3_35=`35`, f3_40=`40`, f3_45=`45`, f3_50=`50`, f3_55=`55`, f3_60=`60`, f3_65=`65`, f3_70=`70`, f3_75=`75`, f3_80=`80`, f3_85=`85`, f3_90=`90`, f3_95=`95`, f3_100=`100`)

data_morph = f1_values %>%
	inner_join(f2_values) %>%
	inner_join(f3_values)
